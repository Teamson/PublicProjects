...
declare namespace wx {
   ...
   * @param param 参数
   */
  export function aldSendEvent(eventName: string, param?: any)
  ...
  /////////////////////////////////广告///////////////////////////////
  /**创建BannerAd */
  export function createBannerAd(object: any): any

  /**创建推荐组件BannerAd */
  export function createGameBanner(object: any): any

  /**创建视频广告 */
  export function createRewardedVideoAd(object: any): any
   ...
   * ​显示模态弹窗
   */
  export function showModal(object: any): void; //_showModalObject
  ...
  /**分享 */
  export function shareAppMessage(shareObj: any): void;
